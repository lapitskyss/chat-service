...
//
//	mockgen -source=handler.go -destination=mocks/handlers_mocks.gen.go -package=clienthandlermocks
//
// Package clienthandlermocks is a generated GoMock package.
package clienthandlermocks
...
func (m *MockTypingMessageUseCase) Handle(ctx context.Context, req clienttypingmessage.Request) error {
	m.ctrl.T.Helper()
